...
if (!empty($tagid)) {
    ...
    $navlinks[] = array('name' => $tagrec->name, 'link' => "index.php", 'type' => 'misc');
}
...
print_header("$COURSE->shortname: $blogstring", $COURSE->fullname, $navigation,'','',true);
...
/// TODO Layout the whole page as three big columns.
